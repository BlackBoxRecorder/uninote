...
- [src/stores/editor-store.ts:1-211](file://src/stores/editor-store.ts#L1-L211)
...
## 核心组件
- DiaryStore：负责日记列表、年份导航、周展开/收起、当前选中日记、初始化流程与周分组计算。
...
Store-->>UI : 更新 selectedYear/diaryEntries/loading
```
...
- 关键状态
  ...
  - loading/initialized：加载与初始化标记
- 关键方法
  - 年份导航：setSelectedYear/prevYear/nextYear
  - 列表拉取：fetchDiaries
  - 初始化：ensureToday/initDiary
...
图表来源
- [src/stores/diary-store.ts:21-38](file://src/stores/diary-store.ts#L21-L38)
- [src/stores/diary-store.ts:12-19](file://src/stores/diary-store.ts#L12-L19)

章节来源
- [src/stores/diary-store.ts:40-234](file://src/stores/diary-store.ts#L40-L234)
...
- [src/stores/editor-store.ts:204-211](file://src/stores/editor-store.ts#L204-L211)
- [src/app/api/diaries/[id]/route.ts:26-57](file://src/app/api/diaries/[id]/route.ts#L26-L57)
- [src/stores/diary-store.ts:135-138](file://src/stores/diary-store.ts#L135-L138)
...
- 组件依赖
  ...
  - DiarySidebar/DiaryWeekItem 依赖 DiaryStore 的年份、列表、展开状态
...
章节来源
- [src/app/api/diaries/open/route.ts:14-73](file://src/app/api/diaries/open/route.ts#L14-L73)
- [src/app/api/diaries/route.ts:6-36](file://src/app/api/diaries/route.ts#L6-L36)
- [src/app/api/diaries/[id]/route.ts:26-57](file://src/app/api/diaries/[id]/route.ts#L26-L57)
- [src/stores/editor-store.ts:66-77](file://src/stores/editor-store.ts#L66-L77)

## 结论
DiaryStore 将“年-周-日”三层时间轴与“列表-展开-选中”三类状态有机结合，配合 EditorStore 的内容缓存与保存流程，形成了清晰、可维护的日记状态管理方案。通过数据库索引与渲染层缓存，系统在性能与体验上取得平衡。未来可在搜索/筛选、导入导出、统计可视化等方面进一步扩展。
...
- [src/app/api/diaries/open/route.ts:14-121](file://src/app/api/diaries/open/route.ts#L14-L121)
- [src/app/api/diaries/ensure/route.ts:8-118](file://src/app/api/diaries/ensure/route.ts#L8-L118)
- [src/app/api/diaries/[id]/route.ts:6-57](file://src/app/api/diaries/[id]/route.ts#L6-L57)